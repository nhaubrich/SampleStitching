...
class Processor(processor.ProcessorABC):
    def __init__(self,sampleInfo,channel,stitchResults,doPresel):
...
if __name__ == "__main__":
    ...
    if args.local:
        output = processor.run_uproot_job(
            fileset,
            "Events",
            Processor(channel=args.channel,sampleInfo=samplesToRun,stitchResults=stitchResults),
        ...
        output,meta = processor.run_uproot_job(
            fileset,
            treename="Events",
            processor_instance=Processor(channel=args.channel,sampleInfo=samplesToRun,stitchResults=stitchResults,doPresel=args.preselection),
